...
public class DownloadFileThread {
    public static void main(String[] args) throws IOException {
        URL url = new URL("https://vpic-cover.puui.qpic.cn/e3174w5iypu/e3174w5iypu_1759818942_hz.jpg");
        ...
        String outputPath = "D:/java/code/paicoding/paicoding-web/src/main/java/com/github/paicoding/forum/web/javabetter/network/image/file.png";
